...
public class ScoreController : MonoBehaviour {
	...
	public void startGame(){
		...
		GameObject.Find ("boom").GetComponent<Renderer> ().enabled = false;

		GameObject.Find ("Main Camera").transform.parent = GameObject.Find ("AircraftJet").transform;
		GameObject.Find ("boom").transform.parent = GameObject.Find ("AircraftJet").transform;
	...
	void destroyPlane(){
		...
		GameObject.Find ("boom").transform.parent = GameObject.Find ("Owner").transform;
		GameObject.Find ("boom").GetComponent<Renderer> ().enabled = true;
		GameObject.Find ("boom").GetComponent<AudioSource> ().PlayOneShot (GameObject.Find ("boom").GetComponent<AudioSource> ().clip);
