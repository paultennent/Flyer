...
public class TerrainGenerator : MonoBehaviour {
	...
	public float planeSize = 600f;//60f;
	...
	public void updateWithoutGenerating(float detailScale, float heightScale){
		this.detailScale = detailScale;
		this.heightScale = heightScale;
	}
    ...
    private Tile GenerateTile(int x, int z) {
        GameObject plane =
                    (GameObject)Instantiate(terrainPlane, new Vector3(x * planeSize, -50, z * planeSize), Quaternion.identity);
